...
비율: 25.0% */
        ...
        System.out.println("비율: "+(d1/d2)*100+"%");
...
결과: true */
        ...
        System.out.println("결과 : "+((num1%2)==0));
...
결과: true */
        ...
        System.out.println("결과 : "+((num2%7)==0));
...
결과: true */
        ...
        System.out.println("결과: "+((num3%7)==0&&((num3%2)!=0)));
...
결과: 합격 */
        ...
        System.out.println("결과 : "+((score2+score1) >= 150 ? "합격" : "불합격"));
...
화씨 온도: 86.0 */
        ...
        double ondo = scan.nextDouble();
        System.out.println("화씨 온도 : "+((ondo*9.0/5.0)+32));
...
2025년 기준 나이: 27세 */
        ...
        System.out.println("2026년 기준 나이:"+(2025-year)+"세");
...
BMI 지수: 22.34... */
        ...
        System.out.println("BMI 지수:" +(weight/((key/100.0)*(key/100.0))));
...
결과: 관리자 */
        ...
        System.out.println("결과 : "+(userid.equals("admin")||email.equals("admin@test.com")? "관리자" : "일반 사용자"));
...
등급:B */
        ...
        System.out.println("점수를 입력하세요: 88");
        int A = scan.nextInt();
        System.out.println("등급: "+(A >= 90 ? 'A' : A >= 80 ? 'B' : 'C'));
