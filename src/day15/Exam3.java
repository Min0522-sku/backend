...
public class Exam3 {
    ...
    public static void main(String[] args) {
        ...
        // 0~9 사이의 난수         .nextxxx(개수)
        int val1 = random.nextInt();  // INT 타입 허용 범위내 난수 생성
        System.out.println("val1 = " + val1);
        int val2 = random.nextInt(10);
        System.out.println("val2 = " + val2);
        // 1~10 사이의 난수   .nextxxx(개수)+ 시작값
        ...
        // 활용처 : 특정한 목록에서 하나의 항목 랜덤 선택
        ArrayList<String> list = new ArrayList<>();
        list.add("강호동"); list.add("유재석"); list.add("신동엽");
        int index = random.nextInt(list.size()); // 리스트내 항목 개수 만큼 난수 생성
        ...
        /*
            UUID 장점
                ...
                - 랜덤기반 식별자
            사용처:
                -데이터베이서 pk , 파일명, 로그인세션(Token) 등등
                    - mysql auto_increment : 1,2,3,4,5 순으로 증가하면 가볍고 노출이 쉽다.
                    - UUID: 난수 이므로 무겁고 노출이 어렵다  보안성이 좋음
        */
