...
public class Exam3 {
    public static void main(String[] args) {
        ...
        obj2.show(); // 부모메소드 대신 오버라이딩된 메소드 실행
        obj2.show2();

        //타입변환 자식 -> 부모
        상위클래스 obj3 = obj2;
        obj3.show(); // 부모와 자식간 메소드가 동일하면 오버라이딩된 메소드가 최우선

        // 부모와 자식간의 멤버변수간의 공유가능
...
class 하위클래스 extends 상위클래스{
    ...
    void show2(){
        ...
        System.out.println(this.value3); // this 현재겍체
        System.out.println(super.value1);// super 상위 객체
        //부모와 자식 간의 멤버변수명이 동일할때 this, super 사용한 구분 한다.
    }
}